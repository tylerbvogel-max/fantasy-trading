...
# Difficulty scale (ski slope):
#   1 = Green Circle      (basic definitions)
#   2 = Blue Square        (applying concepts)
#   3 = Black Diamond      (calculations, analysis)
#   4 = Double Black Diamond (multi-concept reasoning)
#   5 = Triple Black Diamond (advanced synthesis)

# Each fact: (id, topic_id, title, explanation, order, question_text, A, B, C, D, correct, difficulty)
FACTS = [
    # ── Stock Market Basics ──
    ("sb-1", "stock-basics", "What Is a Stock?",
     ...
     "A loan to the company", "Partial ownership of the company", "A guarantee of profit", "A bond from the company", "B", 1),
    ...
    ("sb-2", "stock-basics", "Stock Exchanges",
     ...
     "To set stock prices by law", "To guarantee investors make money", "To provide a marketplace for buying and selling stocks", "To create new companies", "C", 1),
    ...
    ("sb-3", "stock-basics", "Ticker Symbols",
     ...
     "The stock's price", "A unique abbreviation identifying a stock", "The company's stock rating", "A tax identification number", "B", 1),
    ...
    ("sb-4", "stock-basics", "Bull vs Bear Markets",
     ...
     "Falling stock prices", "Rising stock prices and optimism", "No trading activity", "Only tech stocks go up", "B", 1),
    ...
    ("sb-5", "stock-basics", "Market Capitalization",
     ...
     "Revenue minus expenses", "Total assets minus liabilities", "Stock price times total shares outstanding", "Annual profit times 10", "C", 2),
    ...
    ("sb-6", "stock-basics", "Dividends",
     ...
     "A fee charged by brokers", "A cash payment from a company to its shareholders", "A type of stock split", "The difference between buy and sell price", "B", 1),
    ...
    ("sb-7", "stock-basics", "IPO — Initial Public Offering",
     ...
     "A company goes bankrupt", "A private company sells shares to the public for the first time", "Existing shares are split in half", "The government buys company stock", "B", 1),
    ...
    ("sb-8", "stock-basics", "Market Hours",
     ...
     "24 hours a day, 7 days a week", "Monday-Friday, 9:30 AM - 4:00 PM ET", "Monday-Saturday, 8 AM - 6 PM ET", "Only during business days, 10 AM - 3 PM ET", "B", 1),
    ...
    ("sb-9", "stock-basics", "Indexes",
     ...
     "The 500 cheapest stocks", "500 large US companies", "All stocks on the NYSE", "Only technology companies", "B", 1),
    ...
    ("sb-10", "stock-basics", "Why Prices Move",
     ...
     "Government regulations only", "Supply and demand", "The company's CEO's salary", "The number of employees", "B", 1),
    ...
    ("t-1", "trading-101", "Market Orders",
     ...
     "The exact price you want", "Immediate execution at the best available price", "No fees on the trade", "A profit on the trade", "B", 1),
    ...
    ("t-2", "trading-101", "Limit Orders",
     ...
     "It always executes immediately", "You control the price at which the trade executes", "It guarantees a profit", "It has lower fees than market orders", "B", 2),
    ...
    ("t-3", "trading-101", "Bid-Ask Spread",
     ...
     "The daily price range of a stock", "The difference between the highest and lowest price ever", "The gap between what buyers will pay and sellers will accept", "The broker's commission fee", "C", 2),
    ...
    ("t-4", "trading-101", "Volume",
     ...
     "The stock price is too high", "Lots of trading activity and usually better liquidity", "The company is in trouble", "The market is about to close", "B", 2),
    ...
    ("t-5", "trading-101", "Going Long vs Short",
     ...
     "Holding the stock for over a year", "Buying the stock expecting it to increase in value", "Borrowing shares to sell them", "Investing in long-term bonds", "B", 1),
    ...
    ("t-6", "trading-101", "Stop-Loss Orders",
     ...
     "To guarantee a profit on every trade", "To automatically sell a stock if it drops to a set price", "To buy more shares when the price drops", "To prevent others from trading the same stock", "B", 2),
    ...
    ("t-7", "trading-101", "Day Trading vs Investing",
     ...
     "Day traders only use limit orders", "Day trading involves same-day trades; investing is long-term holding", "Investing has no risk", "Day trading is only for professionals", "B", 2),
    ...
    ("t-8", "trading-101", "Commission-Free Trading",
     ...
     "They charge hidden fees on every trade", "Through payment for order flow, interest, and premium services", "They don't make any money", "By taking a percentage of your profits", "B", 2),
    ...
    ("t-9", "trading-101", "After-Hours Trading",
     ...
     "Higher volume than regular hours", "Lower volume and wider bid-ask spreads", "It's only available to institutional investors", "Prices are fixed until the next market open", "B", 2),
    ...
    ("t-10", "trading-101", "Paper Trading",
     ...
     "Trading physical stock certificates", "Practicing with simulated money to learn without risk", "A special type of options trading", "Trading only penny stocks", "B", 1),
    ...
    ("pm-1", "portfolio-mgmt", "Diversification",
     ...
     "To maximize returns on a single stock", "To reduce risk by spreading investments across different assets", "To avoid paying taxes", "To focus only on one sector", "B", 1),
    ...
    ("pm-2", "portfolio-mgmt", "Asset Allocation",
     ...
     "Buying only tech stocks", "Dividing investments across different asset types like stocks, bonds, and cash", "Putting all money in the safest investment", "Timing when to buy and sell", "B", 2),
    ...
    ("pm-3", "portfolio-mgmt", "Rebalancing",
     ...
     "Selling all your stocks at once", "Adjusting your portfolio back to your target allocation", "Only buying new stocks", "Switching to a new broker", "B", 2),
    ...
    ("pm-4", "portfolio-mgmt", "Dollar-Cost Averaging",
     ...
     "You invest a lump sum when the market dips", "You invest a fixed amount at regular intervals regardless of price", "You only buy stocks below their average price", "You sell stocks that cost more than average", "B", 2),
    ...
    ("pm-6", "portfolio-mgmt", "Sector Diversification",
     ...
     "To guarantee profits in every sector", "To reduce the impact of a downturn in any single sector", "Because the government requires it", "To make your portfolio look more impressive", "B", 2),
    ...
    ("pm-7", "portfolio-mgmt", "Cash Position",
     ...
     "Cash always grows faster than stocks", "You have flexibility to buy when opportunities arise", "Cash positions are tax-free", "Brokers pay higher interest than banks", "B", 2),
    ...
    ("pm-8", "portfolio-mgmt", "Benchmark Comparison",
     ...
     "To determine their tax bracket", "To evaluate whether their stock picks outperform the market", "Because the SEC requires it", "To decide when to retire", "B", 3),
    ...
    ("pm-9", "portfolio-mgmt", "Unrealized vs Realized Gains",
     ...
     "A profit from a stock you've already sold", "A paper profit on a stock you still hold", "Interest earned on cash", "A dividend payment received", "B", 2),
    ...
    ("pm-10", "portfolio-mgmt", "Concentration Risk",
     ...
     "The risk of having too many different investments", "The risk of having too much of your portfolio in a single investment", "The risk of investing in concentrated juice companies", "The risk of not investing enough money", "B", 2),
    ...
    ("rr-1", "risk-reward", "Risk-Return Tradeoff",
     ...
     "Higher risk investments always lose money", "Higher potential returns generally require accepting higher risk", "Risk and return are unrelated", "Lower risk always means lower fees", "B", 1),
    ...
    ("rr-2", "risk-reward", "Volatility",
     ...
     "The stock is very safe", "The stock price swings more dramatically", "The company is about to go bankrupt", "The stock pays high dividends", "B", 2),
    ...
    ("rr-3", "risk-reward", "Beta",
     ...
     "It moves twice as much as the market on average", "It's twice as expensive as the market average", "It has doubled in price this year", "It pays twice the average dividend", "A", 3),
    ...
    ("rr-4", "risk-reward", "Risk Tolerance",
     ...
     "They have more money to invest", "They have more time to recover from market downturns", "Young people are luckier in the stock market", "Because they pay lower taxes", "B", 2),
    ...
    ("rr-5", "risk-reward", "Systematic vs Unsystematic Risk",
     ...
     "Systematic risk", "Unsystematic risk", "Both types equally", "Neither type", "B", 3),
    ...
    ("rr-7", "risk-reward", "The Power of Compounding",
     ...
     "Returns grow linearly over time", "You earn returns on your accumulated returns, creating exponential growth", "The government matches your gains", "Stock prices always go up over time", "B", 2),
    ...
    ("rr-8", "risk-reward", "Loss Aversion",
     ...
     "Preferring to avoid losses more strongly than acquiring equivalent gains", "Being afraid to invest any money at all", "Only investing in risk-free assets", "A strategy to minimize taxes", "A", 3),
    ...
    ("rr-9", "risk-reward", "Sharpe Ratio",
     ...
     "High risk with low returns", "Good returns relative to the amount of risk taken", "The stock is overvalued", "Low trading volume", "B", 4),
    ...
    ("rr-10", "risk-reward", "Black Swan Events",
     ...
     "A predictable market correction", "A rare, unpredictable event with massive market impact", "A type of insider trading", "A stock that doubles in one day", "B", 3),
    ...
    ("fs-1", "financial-stmts", "The Three Financial Statements",
     ...
     "Income Statement, Balance Sheet, Cash Flow Statement", "Revenue Report, Tax Filing, Shareholder Report", "Quarterly Report, Annual Report, SEC Filing", "Profit Statement, Asset Sheet, Bank Statement", "A", 2),
    ...
    ("fs-2", "financial-stmts", "Revenue vs Profit",
     ...
     "They mean the same thing", "Revenue is total sales; profit is revenue minus expenses", "Revenue is after taxes; profit is before", "Profit is always higher than revenue", "B", 1),
    ...
    ("fs-3", "financial-stmts", "Gross vs Net Income",
     ...
     "Revenue before any deductions", "Revenue minus only production costs", "Total profit after all expenses, taxes, and interest", "The company's cash in the bank", "C", 2),
    ...
    ("fs-4", "financial-stmts", "Balance Sheet Basics",
     ...
     "Revenue = Expenses + Profit", "Assets = Liabilities + Shareholders' Equity", "Cash = Debt - Revenue", "Profit = Revenue - Taxes", "B", 2),
    ...
    ("fs-5", "financial-stmts", "Cash Flow Statement",
     ...
     "The company has no debt", "The company's day-to-day business generates cash", "The company is selling its assets", "The company just issued new stock", "B", 3),
    ...
    ("fs-6", "financial-stmts", "Earnings Per Share (EPS)",
     ...
     "Stock price divided by number of shares", "Net income divided by number of outstanding shares", "Revenue divided by total expenses", "Dividends divided by stock price", "B", 2),
    ...
    ("fs-7", "financial-stmts", "Quarterly Earnings Reports",
     ...
     "They determine the company's stock ticker", "They show financial performance and can cause significant stock price moves", "They are required to pay dividends", "They set the company's stock price for the next quarter", "B", 2),
    ...
    ("fs-8", "financial-stmts", "Debt-to-Equity Ratio",
     ...
     "The company has very little risk", "The company relies heavily on borrowed money", "The company is very profitable", "The company pays high dividends", "B", 3),
    ...
    ("fs-9", "financial-stmts", "Free Cash Flow",
     ...
     "Revenue minus all expenses", "Operating cash flow minus capital expenditures", "Cash from selling stock", "Total cash in the bank", "B", 3),
    ...
    ("fs-10", "financial-stmts", "10-K vs 10-Q",
     ...
     "A daily trading report", "A comprehensive annual financial report filed with the SEC", "A report on the top 10,000 stocks", "A tax filing for investors", "B", 2),
    ...
    ("vm-1", "valuation", "Price-to-Earnings (P/E) Ratio",
     ...
     "The stock price is $25", "Investors pay $25 for every $1 of earnings", "The company earns 25% profit", "The stock has risen 25% this year", "B", 2),
    ...
    ("vm-2", "valuation", "Forward vs Trailing P/E",
     ...
     "Trailing looks backward at actual earnings; forward uses estimated future earnings", "They're the same but calculated differently", "Trailing P/E is always higher", "Forward P/E uses revenue instead of earnings", "A", 3),
    ...
    ("vm-3", "valuation", "Price-to-Book (P/B) Ratio",
     ...
     "The company is overvalued", "The stock might be trading below its asset value", "The company has too much debt", "The stock is too expensive", "B", 3),
    ...
    ("vm-4", "valuation", "Market Cap Categories",
     ...
     "Micro-cap", "Small-cap", "Mid-cap", "Large-cap", "D", 2),
    ...
    ("vm-7", "valuation", "Enterprise Value",
     ...
     "It's always lower than market cap", "It accounts for a company's debt and cash position", "It's easier to calculate", "The SEC requires its use", "B", 3),
    ...
    ("vm-9", "valuation", "Overvalued vs Undervalued",
     ...
     "Its price is zero", "Its market price is below its estimated true worth", "It has negative earnings", "It doesn't pay dividends", "B", 2),
    ...
    ("vm-10", "valuation", "Comparing Within Sectors",
     ...
     "Different sectors have different typical valuation ranges", "The SEC requires sector-specific comparisons", "All sectors have the same average P/E", "It doesn't matter — P/E is universal", "A", 3),
    ...
    ("ef-1", "etfs-funds", "What Is an ETF?",
     ...
     1, "What is an ETF?",
     "A type of savings account", "A basket of stocks that trades like a single stock", "A government bond", "A type of cryptocurrency", "B", 1),
    ...
    ("ef-2", "etfs-funds", "Index Funds",
     ...
     "To beat the market every year", "To match the performance of a specific market index", "To invest only in small companies", "To generate maximum dividends", "B", 1),
    ...
    ("ef-4", "etfs-funds", "ETFs vs Mutual Funds",
     ...
     "ETFs can only be bought once a day", "ETFs trade throughout the day; mutual funds trade once at market close", "Mutual funds trade more frequently", "There's no difference", "B", 2),
    ...
    ("ef-5", "etfs-funds", "Sector ETFs",
     ...
     "An ETF that holds only one stock", "An ETF focused on a specific industry sector", "A government-issued bond fund", "An ETF that tracks all sectors equally", "B", 1),
    ...
    ("ef-6", "etfs-funds", "Dividend ETFs",
     ...
     "They guarantee high returns", "They provide regular income from dividend-paying stocks", "They never lose value", "They are only available to professional investors", "B", 2),
    ...
    ("ef-7", "etfs-funds", "Bond ETFs",
     ...
     "Bonds always outperform stocks", "For stability and income, especially during stock market downturns", "Bond ETFs have no fees", "The government requires a minimum bond allocation", "B", 2),
    ...
    ("ef-8", "etfs-funds", "Thematic ETFs",
     ...
     "Track the overall market", "Invest in specific trends or themes like AI or clean energy", "Only hold government bonds", "Minimize all risk", "B", 2),
    ...
    ("ef-9", "etfs-funds", "Passive vs Active Investing",
     ...
     "Active investing always wins", "Passive investing tends to outperform most active strategies over time", "They perform exactly the same", "Active investing has lower fees", "B", 3),
    ...
    ("ef-10", "etfs-funds", "SPY, QQQ, and DIA",
     ...
     "S&P 500", "Dow Jones Industrial Average", "NASDAQ-100", "Russell 2000", "C", 2),
    ...
    ("mp-1", "market-psych", "Fear and Greed",
     ...
     "When everyone is buying and prices are rising fast", "When everyone is selling in fear", "When the market is completely flat", "Only during IPOs", "B", 2),
    ...
    ("mp-2", "market-psych", "Herd Behavior",
     ...
     "A strategy used by professional traders", "Following the crowd instead of making independent decisions", "Only investing in agricultural stocks", "Diversifying across all sectors", "B", 1),
    ...
    ("mp-3", "market-psych", "FOMO — Fear of Missing Out",
     ...
     "It causes them to sell too early", "It often leads to buying near the top after big price increases", "It makes them too cautious", "It prevents them from diversifying", "B", 2),
    ...
    ("mp-4", "market-psych", "Confirmation Bias",
     ...
     "Confirming your trades were executed", "Seeking information that supports your existing beliefs while ignoring contrary evidence", "Verifying stock prices are accurate", "Double-checking your broker's fees", "B", 2),
    ...
    ("mp-5", "market-psych", "Sunk Cost Fallacy",
     ...
     "How much have I already lost on this stock?", "Would I buy this stock today at its current price?", "When did I originally buy this stock?", "How much did my friends invest?", "B", 3),
    ...
    ("mp-6", "market-psych", "Market Bubbles",
     ...
     "Stock prices steadily matching earnings growth", "Widespread euphoria and 'this time is different' thinking", "Low trading volume", "Investors being cautious", "B", 3),
    ...
    ("mp-7", "market-psych", "Panic Selling",
     ...
     "It triggers tax benefits", "It locks in losses and you often miss the recovery", "It's illegal during market hours", "Brokers charge extra fees for it", "B", 2),
    ...
    ("mp-8", "market-psych", "Anchoring Bias",
     ...
     "Fixing your portfolio to one stock", "Over-relying on a specific reference price when making investment decisions", "Buying stocks at their IPO price", "Setting stop-loss orders", "B", 3),
    ...
    ("mp-9", "market-psych", "Patience Pays",
     ...
     "You should trade as frequently as possible", "Staying invested long-term outperforms trying to predict market moves", "The best time to invest is at market open", "You should only invest during market hours", "B", 2),
    ...
    ("mp-10", "market-psych", "Emotional Discipline",
     ...
     "Having the most capital to invest", "Emotional discipline and sticking to a strategy", "Following social media stock tips", "Trading as frequently as possible", "B", 2),
    ...
    ("ei-1", "econ-indicators", "GDP — Gross Domestic Product",
     ...
     "The total national debt", "The total value of goods and services produced in a country", "The unemployment rate", "The stock market's total value", "B", 1),
    ...
    ("ei-3", "econ-indicators", "Interest Rates",
     ...
     "They cause stock prices to fall", "They're positive for stocks because borrowing is cheaper", "They have no effect on stocks", "They only affect bond prices", "B", 2),
    ...
    ("ei-4", "econ-indicators", "Unemployment Rate",
     ...
     "Lower stock prices", "Inflation, as companies raise wages to compete for workers", "Higher unemployment later", "Lower interest rates", "B", 3),
    ...
    ("ei-5", "econ-indicators", "CPI — Consumer Price Index",
     ...
     "Corporate profit margins", "The cost of a basket of everyday consumer goods and services", "Stock market performance", "Government spending", "B", 2),
    ...
    ("ei-6", "econ-indicators", "Jobs Report (Non-Farm Payrolls)",
     ...
     "The last day of each month", "The first Friday of each month", "Every Wednesday", "Quarterly", "B", 2),
    ...
    ("ei-7", "econ-indicators", "The Fed and Monetary Policy",
     ...
     "Lower interest rates and easy money", "Higher interest rates to cool the economy", "Increased government spending", "Deregulation of banks", "B", 3),
    ...
    ("ei-8", "econ-indicators", "Yield Curve",
     ...
     "A strong economy ahead", "A potential recession", "Higher stock prices", "Lower inflation", "B", 4),
    ...
    ("ei-9", "econ-indicators", "Consumer Confidence",
     ...
     "It doesn't affect stocks at all", "Confident consumers spend more, boosting corporate profits", "It directly sets stock prices", "It only affects bond markets", "B", 3),
    ...
    ("ei-10", "econ-indicators", "Leading vs Lagging Indicators",
     ...
     "The unemployment rate", "Consumer expectations and building permits", "Corporate quarterly earnings", "Past inflation data", "B", 3),
]
